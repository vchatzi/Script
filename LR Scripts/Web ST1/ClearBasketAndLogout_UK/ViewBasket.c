ViewBasket()
{
    ...
    /*web_reg_save_param("itemid","LB=<span class=\"textTitle\">","RB=</span>","ORD=ALL",LAST);
    web_reg_save_param("itemidform","LB=<input type=\"hidden\" name=\"shoppingBasketForm:","RB=\"","ORD=ALL",LAST);
    web_reg_save_param("qtyno","LB=value=\"","RB=\" class=\"inputText costColumn floatLeft","ORD=ALL",LAST);    
    web_reg_save_param("qtynoform","LB=<input type=\"text\" name=\"shoppingBasketForm:","RB=\" value=\"","ORD=ALL",LAST);
    web_reg_save_param("basketformnostock","LB=<input type=\"text\" name=\"shoppingBasketForm:","RB=\" class=\"inputText quickStockNo inactiveInput\"","ORD=1",LAST);
    web_reg_save_param("basketformnoQty","LB=<input type=\"text\" name=\"shoppingBasketForm:","RB=\" class=\"inputText inputQty numbersOnly inactiveInput\"","ORD=1",LAST);
    web_reg_save_param("Finalbasketformid","LB=<a href=\"#\" onclick=\"if(typeof jsfcljs == 'function'){jsfcljs(document.getElementById('shoppingBasketForm'),{'shoppingBasketForm:","RB='","ORD=1",LAST);    
	web_reg_save_param("login","LB=<input id=\"shoppingBasketForm:LoggedInUserSendToColleagueWidgetAction_mailTo_decorate:LoggedInUserSendToColleagueWidgetAction_mailTo\" type=\"text\" name=\"shoppingBasketForm:LoggedInUserSendToColleagueWidgetAction_mailTo_decorate:LoggedInUserSendToColleagueWidgetAction_mailTo\" value=\"","RB=\"","ORD=1",LAST);
	web_reg_save_param("viewstatebasket","LB=<input type=\"hidden\" name=\"javax.faces.ViewState\" id=\"javax.faces.ViewState\" value=\"","RB=\"","ORD=1",LAST);*/
   ...
   web_reg_save_param("c_qty",
	...
	lr_end_transaction("UK-10-ViewBasket", LR_AUTO);

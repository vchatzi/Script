# 1 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c"
...
# 1 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
# 2 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
# 8 "globals.h" 2
    ...
    int i =0;
     ...
     int vcount=0;
     int ccount=0;
# 3 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
# 4 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
HomePage()
{
	...
	lr_end_transaction("AU-01-HomePage",2);
	return 0;
}
# 5 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
Login()
{
	...
	lr_end_transaction("AU-02-ClkLoginLink", 2);
	...
	lr_end_transaction("AU-03-Login",2);
	
	web_set_sockets_option("SSL_VERSION", "TLS1.1");
	
	return 0;
}
# 6 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
PredectiveSearch()
{
	...
	lr_end_transaction("AU-04-PredictiveSearch",2);
...
# 7 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
HierarchicalSearch()
{
	...
	web_reg_save_param_regexp(
    	"ParamName=TN_Page",
    	"RegExp=:\/\/st1-au.rs-online.com\/web\/c\/(.+?)\/(.+?)\/(.+?)\/\" title=\"",
	...
	lr_start_transaction("AU-04-HierarchySearch");
	...
	lr_end_transaction("AU-04-HierarchySearch", 2);	
...
# 8 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
{	
	...
	lr_start_transaction("AU-05-BrowseByProductCategory");
	web_url("2-Way Radio Rechargeable Batteries", 
		...
		"Mode=HTML", 
		"LAST");
	   lr_end_transaction("AU-05-BrowseByProductCategory", 2);
...
# 9 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
ViewProductDeatils()
{
	...
	lr_end_transaction("AU-06-ViewProductDetailsPage",2);

	return 0;
}
# 10 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
CheckStockLevel()
{
	...
	lr_end_transaction("AU-07-CheckStockLevelLink", 2);
	...
	lr_end_transaction("AU-08-CheckStockLevel", 2);
...
# 11 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
AddtoBasket()
{
	...
	lr_start_transaction("AU-09-ClkAddtoBasket");
	...
	web_submit_data("0281035_5", 
		...
		"TargetFrame=", 
		"RecContentType=text/html", 
		"Referer=https://{p_URL}/web/p/socket-{p_searchParam}ews/0292271/", 
		"Snapshot=t16.inf", 
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=AJAXREQUEST", "Value={c_ajaxReq}", "ENDITEM",  
	...
	lr_end_transaction("AU-09-ClkAddtoBasket", 2);

	lr_think_time(1);

	return 0;
}
# 12 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
ViewBasket()
{
   ...
   web_reg_save_param("c_qty",
	...
	lr_end_transaction("AU-10-ViewBasket", 2);
...
# 13 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
CheckoutSecurely()
{
	...
	lr_end_transaction("AU-11-CheckoutSecurely",2);
	lr_think_time(1);
	
	return 0;
}
# 14 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2

# 1 "ClearBasketandLogOut.c" 1
ClearBasketandLogOut()
{
	lr_start_transaction("AU-15-ClearBasket");
	web_reg_find("Search=All",
		"SaveCount=",
		"Text=\"page_type\":\"basket\"",
		"LAST");
	...
	lr_end_transaction("AU-15-ClearBasket", 2);
	
	lr_think_time(1);
	
	lr_start_transaction("AU-16-ClkLogout");
	...
	web_url("web", 
		"URL=https://{p_URL}/web?locale=au&unique=1453930497500-3350773362913288068", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
	...
	lr_end_transaction("AU-16-ClkLogout",2);

	return 0;
}
# 15 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2
...
# 16 "d:\\loadrunner\\scripts\\agile pe\\integrated load testing\\st1\\web\\clearbasketandlogout_au\\\\combined_ClearBasketAndLogout_AU.c" 2

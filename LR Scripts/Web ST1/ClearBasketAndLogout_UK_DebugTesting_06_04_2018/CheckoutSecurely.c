...
//		web_reg_find("Text=Continue to payment", "FAIL=NOTFOUND", LAST);
	...
	lr_end_transaction("UK-11-CheckoutSecurely",LR_AUTO);
	
	/*
	if (strcmp ("Delivery address",lr_eval_string("{c_logtext}"))==0)
	{
	 ...
	 web_set_sockets_option("SSL_VERSION", "TLS");
	  ...
	  web_custom_request("execute_2", 
		...
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=https://{p_URL}/web/co/delivery/?cid=464", 
		"Snapshot=t12.inf", 
		"Mode=HTML", 
		"EncType=text/plain; charset=UTF-8", 
		"Body=<envelope><header><context></context></header><body><call component=\"ServerSideStateChecker\" method=\"longRunningConversationOk\" id=\"0\">\n<params><param><number>464</number></param><param><str>ready</str></param></params><refs></refs></call></body></envelope>", 
		LAST);
